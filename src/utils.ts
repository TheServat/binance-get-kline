...
export const saveKlineJson = (fileName: string, jsonArray: Array<Kline>) => {
  writeFileSync(fileName, JSON.stringify(jsonArray, null, 2));
};

export const saveKlineCsv = (fileName: string, jsonArray: Array<Kline>) => {
